...
<template>
  <main>
    <div class="relative grid p-8 bg-white place-items-center md:px-6 dark:bg-zinc-900">
      <div class="flex flex-row flex-wrap justify-between w-full gap-4 mb-8 md:mb-4 md:w-5/6 md:ps-4">
        <div class="flex items-center gap-2">
          <h1 class="text-3xl text-gray-700 dark:text-gray-100">MiniQR</h1>
        </div>
        <div class="flex flex-row items-center justify-end gap-4">
          <div class="flex flex-row items-center gap-2">
            <a class="icon-button" href="https://github.com/Mohitpatel021/Mini_QR_Using_VUE.git" target="_blank"
      ...
      <div class="w-full md:w-5/6">
        <div class="flex flex-col-reverse items-start justify-center gap-4 md:flex-row md:gap-12">
          <div id="main-content"
            class="sticky top-0 flex flex-col items-center justify-center w-full p-4 shrink-0 md:w-fit">
            <div id="qr-code-container">
              <div class="grid overflow-hidden place-items-center" :style="[
                  style,
                  {
                    width: '200px',
                    height: '200px'
          ...
          <div id="settings" class="flex flex-col items-start w-full gap-8 grow text-start">
            <div>
            ...
            <div class="w-full">
              ...
              <textarea name="data" class="text-input" id="data" rows="2"
            ...
            <fieldset class="flex-1" role="radiogroup" tabindex="0">
              <div class="flex flex-row items-center gap-2">
                ...
                <a href="https://docs.uniqode.com/en/articles/7219782-what-is-the-recommended-error-correction-level-for-printing-a-qr-code"
                  target="_blank" class="flex flex-row items-center icon-button"
            ...
            <div class="w-full">
              <div class="flex flex-row items-center gap-2 mb-2">
                ...
                <button class="flex flex-row items-center icon-button" @click="uploadImage">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                      stroke-width="2">
                      <path d="M14 3v4a1 1 0 0 0 1 1h4" />
            ...
            <div id="dots-squares-settings" class="flex flex-col flex-wrap w-full gap-6 mb-4 md:flex-row">
              <fieldset class="flex-1" role="radiogroup" tabindex="0">
